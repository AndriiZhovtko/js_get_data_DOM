...
if (totalPopulationElement) totalPopulationElement.textContent = formatNumber(totalPopulation);
const averagePopulationElement = document.querySelector(".average-population");
if (averagePopulationElement) averagePopulationElement.textContent = formatNumber(averagePopulation);
